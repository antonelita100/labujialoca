...
const ProductsPage = () => {
  const products = [
    { id: 1, name: 'Aceite Semisintético Puma 4L', image: imagesFolderAceites('./semisintetico.png'), category: 'Aceites'  },
    { id: 2, name: 'Aceite Semisintético Puma 1L', image: imagesFolderAceites('./semisintetico2.png'), category: 'Aceites'  },
    { id: 3, name: 'Aceite Sintético Puma 4L', image: imagesFolderAceites('./sintetico.png'), category: 'Aceites'  },
    { id: 4, name: 'Aceite Sintético Puma 1L', image: imagesFolderAceites('./sintetico2.png'), category: 'Aceites'  },
    ...
    { id: 7, name: 'Bujía Champion', image: imagesFolderEncendido('./bujia.jpeg'), category: 'Encendido' },
    { id: 8, name: 'Bujía NGK', image: imagesFolderEncendido('./bujia2.jpeg'), category: 'Encendido' },
    { id: 9, name: 'Cable de Bujías AcDelco', image: imagesFolderEncendido('./cables.jpeg'), category: 'Encendido' },
    { id: 10, name: 'Cable de Bujías Genoud', image: imagesFolderEncendido('./cables2.jpeg'), category: 'Encendido' },
    ...
    { id: 13, name: 'Iluminación Efecto Xenon', image: imagesFolderLamparas('./lamparas.jpeg'), category: 'Lamparas' },
    { id: 14, name: 'Luces Led', image: imagesFolderLamparas('./lamparas2.jpeg'), category: 'Lamparas' },
    { id: 15, name: 'Lámpara de Señalización', image: imagesFolderLamparas('./lamparas3.jpeg'), category: 'Lamparas' },
    ...
    { id: 18, name: 'Silicona Líquida', image: imagesFolderLimpieza('./limpieza2.jpeg'), category: 'Limpieza' },
    { id: 19, name: 'Shampoo Envasado', image: imagesFolderLimpieza('./limpieza3.jpeg'), category: 'Limpieza' },
    { id: 20, name: 'Gamuza Sintética', image: imagesFolderLimpieza('./limpieza4.jpeg'), category: 'Limpieza' },
    ...
    { id: 24, name: 'Cera Líquida', image: imagesFolderLimpieza('./limpieza8.jpeg'), category: 'Limpieza' },
    ...
    { id: 31, name: 'Líquido Refrigerante Concentrado', image: imagesFolderRefrigeracion('./refrigerante.jpeg'), category: 'Refrigerante' },
    { id: 32, name: 'Líquido Refrigerante Petronas', image: imagesFolderRefrigeracion('./refrigerante2.jpeg'), category: 'Refrigerante' },
    { id: 33, name: 'Agua Desmineralizada', image: imagesFolderRefrigeracion('./refrigerante3.jpeg'), category: 'Refrigerante' },
    { id: 34, name: 'Líquido Refrigerante', image: imagesFolderRefrigeracion('./refrigerante4.jpeg'), category: 'Refrigerante' },
    ...
    { id: 39, name: 'Criquet Hidráulico', image: imagesFolderSeguridad('./seguridad5.jpeg'), category: 'Seguridad' },
